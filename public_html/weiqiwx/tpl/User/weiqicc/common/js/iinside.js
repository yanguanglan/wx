...
G.logic.page = {
    ...
    copy: function () {
   // var tmp =G.domain.t + "/tpl/User/default/common/js/zeroclipboard.swf";
   // alert(tmp);
        ZeroClipboard.setDefaults({
            moviePath: G.domain.t + "tpl/User/zhifeng/common/js/zeroclipboard.swf"
        });
...
//if (!((/www.iMicms.com/i.test(window.location)))) G.domain.t = "/static", G.domain.k = "/wm-xin-a"; 
$(function () {
    G.logic.page.init();
    G.logic.form.init(); 
})

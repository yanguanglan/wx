...
class EstateAction extends BaseAction
{
    ...
    public function news()
    {
		...
		$this->assign('meta_title', $classify['name']);
        $this->display();
    }
    public function newlist()
    {
        ...
        $this->assign('imgtxt', $imgtxt);
		$this->assign('meta_title', $imgtxt['title']);
        $this->display();
    }

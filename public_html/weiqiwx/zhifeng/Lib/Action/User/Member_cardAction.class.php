...
class Member_cardAction extends UserAction
{
    ...
    public function _initialize()
    {
        ...
        $this->wxuser_db->where(array(
            ...
            'allcardnum' => $thisGroup['create_card_num']
        ));
        ...
        if (IS_POST) {
            ...
            if ($data == false) {
                $data = array(
                    'token' => $this->token,
                    'cardname' =>'会员金卡',
                    'logo' => C('site_url') .'/tpl/User/default/common/images/cart_info/logo-card.png',
                    'bg' => C('site_url') .'./tpl/User/default/common/images/card/card_bg01.png',
                    //'diybg' => C('site_url') .'/tpl/User/default/common/images/card/card_bg21.png',
                    'msg' => '微会员卡，方便携带收藏，永不挂失',
                    'numbercolor' => '#000000',
                    'vipnamecolor' => '#00000',
                    'Lastmsg' => C('site_url') .'/tpl/User/default/common/images/cart_info/news.jpg',
                    'vip' => C('site_url') .'/tpl/User/default/common/images/cart_info/vippower.jpg',
                    'qiandao' => C('site_url') .'/tpl/User/default/common/images/cart_info/qiandao.jpg',
                    'shopping' => C('site_url') .'/tpl/User/default/common/images/cart_info/shopping.jpg',
                    'memberinfo' => C('site_url') .'/tpl/User/default/common/images/cart_info/user.jpg',
                    'membermsg' => C('site_url') .'/tpl/User/default/common/images/cart_info/vippower.jpg',
                    'contact' => C('site_url') .'/tpl/User/default/common/images/cart_info/addr.jpg'
                );
            }
    ...
    public function member()
    {
		...
		$members[0]['account']          = $thisUser['account'];

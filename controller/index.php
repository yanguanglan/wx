...
if(Request::get('state')=='qqreg'){
	...
	$keysArr = array(
			...
			"client_id" => '101052619',
			"redirect_uri" => urlencode('http://www.weiqimobile.com'),
			"client_secret" =>'f9e9687d6ef98e5dd57b2f4d0d31b003',
			"code" => $accode
	);
	...
	if(trim($openid)!=''){
		...
		if($u->has_id()){
			...
			//跳转到帐号注册绑定绑定页面
			Redirect::to('/newreg',array('qqopenid'=>$openid,'nick'=>$params['nickname'],'pic'=>$params['figureurl_qq_1']));
	...
	$gkw = "盛世源码微信营销系统、微信营销、微房产、微生活、微餐饮、微汽车、微网站、微商城、微喜帖、微营销、微信定制开发";
	$gde = "盛世源码微信营销系统,最大的微信公众智能服务平台,管家十大微体系:微生活、微菜单、微网站、微会员、微活动、微商城、微服务、微房产、微汽车、微支付、微客服,企业微营销必备。";
	$gti = "盛世源码微信营销系统--最大的微信公众营销推广平台_微信营销,如此简单！";

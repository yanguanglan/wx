...
//$ddzs = $rednum->where(array('wid'=>Session::get('wid'),'wxid'=> Session::get('wxid')))->count();
$ddzs = $rednum->where(array('wid'=>Session::get('wid'),'wxid'=> Session::get('wxid'),'hid'=>Request::get(1)))->count();
//对订单项目解析

...
function init_data($wid,$uid){
	...
	$res  = new Model('res');
	$res->id  = null;
	$res->con = '{"tit":"\u6b22\u8fce\u5173\u6ce8\u5fae\u4fe1\u516c\u4f17\u8d26\u53f7\u3010\u6f14\u793a\u7248\uff0c\u8bf7\u4fee\u6539\u3011","pic":"\/ups\/img_default\/dan.jpg","des":"\u70b9\u51fb\u8fdb\u5165\u5fae\u5b98\u7f51\u3010\u6f14\u793a\u7248\uff0c\u8bf7\u4fee\u6539\u3011","url":"http:\/\/www.weiqimobile.com\/weiweb\/365\/","ourl":"http:\/\/www.weiqimobile.com\/gzzh\/artview-1.html"}';
	$res->wid = $wid;
	$res->uid = $uid;
	$res->typ = 1;
	$res->save();
	...
	$res1 = new Model('res');
	$res1->id  = null;
	$res1->con = '[{"tit":"\u6b22\u8fce\u5173\u6ce8\u5fae\u4fe1\u516c\u4f17\u8d26\u53f7\uff0c\u70b9\u51fb\u8fdb\u5165\u5fae\u5b98\u7f51\u3010\u6f14\u793a\u7248\uff0c\u8bf7\u4fee\u6539\u3011","pic":"\/ups\/img_default\/duo1.jpg","url":"http:\/\/www.weiqimobile.com\/weiweb\/365\/","ourl":"http:\/\/www.weiqimobile.com\/gzzh\/artview-1.html"},{"tit":"\u6b22\u8fce\u5173\u6ce8\u5fae\u4fe1\u516c\u4f17\u8d26\u53f7\uff0c\u6211\u4eec\u5c06\u7aed\u8bda\u4e3a\u60a8\u670d\u52a1","pic":"\/ups\/img_default\/duo.jpg","url":"http:\/\/www.weiqimobile.com\/weiweb\/365\/","ourl":"http:\/\/www.weiqimobile.com\/gzzh\/artview-2.html"}]';
	$res1->wid = $wid;
	$res1->uid = $uid;
	$res1->typ = 2;
	$res1->save();
...
function init_data1($wid,$uid){
	...
	$res_sql1 ="INSERT INTO `res` VALUES (null, '{\"tit\":\"欢迎关注微信公众账号\",\"pic\":\"/ups/img_default/dan.jpg\",\"des\":\"欢迎关注微信公众账号\",\"url\":\"http:\\/\\/www.weiqimobile.com\\/weiweb\\/365\\/\",\"ourl\":\"http:\\/\\/www.weiqimobile.com\\/gzzh\\/artview-1.html\"}', $wid, $uid, '1')";
	$res_sql2="INSERT INTO `res` VALUES (null, '[{\"tit\":\"欢迎关注微信公众账号\",\"pic\":\"/ups/img_default/duo.jpg\",\"url\":\"\",\"ourl\":\"http://www.www.weiqimobile.com/gzzh/artview-1.html\"},{\"tit\":\"欢迎关注微信公众账号\",\"pic\":\"/ups/img_default/duo1.jpg\",\"url\":\"\",\"ourl\":\"\"},{\"tit\":\"欢迎关注微信公众账号\",\"pic\":\"/ups/img_default/dan.jpg\",\"url\":\"\",\"ourl\":\"\"}]', $wid, $uid, '2');";
	$db->query($res_sql1);
	$db->query($res_sql2);
	...
	$res_content = new Model('res_content');
	$res_content_sql11 = "INSERT INTO `res_content` VALUES ($res1->id, '1', '<p>点击进入微官网[演示版，请修改]<br></p>', '欢迎关注微信公众账号，点击进入微官网[演示版，请修改]', 'http://www.weiqimobile.com/weiweb/365/')";
	$res_content_sql12 = "INSERT INTO `res_content` VALUES ($res1->id, '2', '<p>点击进入微官网[演示版，请修改]<br></p>', '欢迎关注微信公众账号，点击进入微官网[演示版，请修改]', 'http://www.weiqimobile.com/weiweb/365/')";
	...
	$xyj_sql = "INSERT INTO `xyj` VALUES (null, $uid,$wid, '无敌幸运星活动开始啦！', '凭此奖品可享受盛世源码套餐相应折扣。【所有设置为演示版，请修改】', '{$begin_time}', '{$end_time}', NULL, '/upload/auto/2013/11/07/c02452257079bb530a7acabf6cd9d20a.jpg', '4', '一等奖', '盛世源码钻石会员试用7天', '0', 5, '二等奖', '盛世源码抵用券50元', '0', 10, '参与奖', '盛世源码抵用券20元', '0', 20, 5, 1, 1, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0);";
	$db->query($xyj_sql);

	$hyk_sql ="INSERT INTO `micro_member_card` VALUES (null, $uid,$wid, '会员回馈月【所有设置为演示版，请修改】', 'CARD获得微信加平台7天试用特权\r\n新功能上线优先体验权\r\n获得渠道代理高额返点优先权\r\n获得微信加平台7天试用特权\r\n新功能上线优先体验权\r\n获得渠道代理高额返点优先权\r\n', '{$begin_time}', '{$end_time}', 100, '/upload/auto/2013/11/07/8f586a735bcc867a4234643baa49572f.jpg', '/upload/auto/2013/11/08/bd8b8e98caa2e11911ff92f7308a9e27.jpg', '/upload/auto/2013/11/07/fa0d5bd577c51a467e606ff57fe9fca0.jpg', '6', '山东临沂万阅城17层', '4006232003', '<span style=\"white-space:nowrap;\">新功能上线优先体验权</span><br />\r\n<span style=\"white-space:nowrap;\">获得渠道代理高额返点优先权</span><br />\r\n<span style=\"white-space:nowrap;\">获得微信加平台7天试用特权</span><br />\r\n<span style=\"white-space:nowrap;\">新功能上线优先体验权</span><br />', '<span style=\"white-space:nowrap;\">新功能上线优先体验权</span><br />\r\n<span style=\"white-space:nowrap;\">获得渠道代理高额返点优先权</span><br />\r\n<span style=\"white-space:nowrap;\">获得微信加平台7天试用特权</span><br />\r\n<span style=\"white-space:nowrap;\">新功能上线优先体验权</span><br />', '<span style=\"white-space:nowrap;\">新功能上线优先体验权</span><br />\r\n<span style=\"white-space:nowrap;\">获得渠道代理高额返点优先权</span><br />\r\n<span style=\"white-space:nowrap;\">获得微信加平台7天试用特权</span><br />\r\n<span style=\"white-space:nowrap;\">新功能上线优先体验权</span><br />', 2, NULL)";
	$db->query($hyk_sql);
	...
	$zxyd_sql ="INSERT INTO `online_booking` VALUES (null,$wid,$uid, '宝马试驾在线预约【所有设置为演示版，请修改】', '试驾宝马全系车型，体验前瞻性主动安全系统，智能车载交互系统，豪华精致的\r\n设计，高效动力操控系统。', '/upload/auto/2013/11/08/62cac18850281adb575eacbddd5841e7.jpg', '临沂市兰山区万阅城17层', '4006232003', '10', '{$begin_time}', '{$end_time}', '车型', '宝马x6,宝马z4,宝马x1,宝马x7', '驱动', '前驱,后驱,全时四驱,适时四驱', NULL, NULL)";
	$db->query($zxyd_sql);

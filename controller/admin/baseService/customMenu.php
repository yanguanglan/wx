...
//微预约新版
$m_wyyn = new Model('newyy');
$wyynres = $m_wyyn->where(array('wid'=>$wid))->order('id desc')->list_all();
...
//万能表单
$m_wnbd = new Model('weiqiwx_selfform');
$wnbdres = $m_wnbd->where(array('token'=>$wid))->order('id desc')->list_all();

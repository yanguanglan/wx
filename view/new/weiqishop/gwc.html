...
<div class="menu_header"> 
     ...
     <div class="menu_topbar">
      ...
      <a class="head_btn_right" href="<?php echo Conf::$http_path.'dc/index-'.Request::get('1').'.html?wxid='.$wxid; ?>">
...
<div class="ui-input-text"><input type="text" id="addr" name="addr" value="<?php echo $m->addr; ?>" placeholder="如：XX小区5号楼318" class="ui-input-text"></div>

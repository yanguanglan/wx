            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span10">
                                <h3><i class="icon-edit"></i>预约设置</h3>
                            </div>
                            <div class="span2"><a class="btn" href="Javascript:window.history.go(-1)">返回</a></div>
                        </div>
                        <div class="box-content">
                            <form action="" method="post" class="form-horizontal form-validate" novalidate id="lbsForm"><?php echo tk();  echo $m->hidden('id'); ?>
								...
								<div class="control-group">
                                    ...
                                    <div class="controls">
                                     ...
                                     <div class="controls">
                                        <div class="row-fluid">
                                            	短信通知内容：<?php echo $m->textarea('noticecontent','class="input-xlarge"'); ?>
                                            	
                                        </div><p style="margin-left:83px;"></p>
                                    </div>
                                </div>
								...
								<div class="control-group">
                                    ...
                                    <div class="controls" id="twfmpicarea">
										<?php echo Conf::$http_path; ?>yuyue/yy-<?php echo $m->id; ?>.html?wid=<?php echo Session::get('wid'); ?>
                                    </div>
                                </div>
                                <?php } ?>

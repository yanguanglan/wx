				...
				<div class="span12">
					<div class="box">
						<div class="box-title">
							<div class="span8">
								<h3>
									<i class="icon-table"></i>第三方接口管理
									<small>管理您的第三方接口</small>
								</h3>
							</div>
						</div>
						<div class="box-content">
							<div class="row-fluid">
								<div class="span8 control-group">
									<a href="listadd.html" class="btn"><i class="icon-plus"></i>添加第三方接口</a>
									<a href="listadd.html?xing=1.html" class="btn"><i class="icon-plus"></i>第三方优先处理图片</a>
									<a href="listadd.html?xing=2.html" class="btn"><i class="icon-plus"></i>第三方全匹配</a>
								</div>

								<div class="span4" style="text-align:right;">
									<form action="" class="form-horizontal form-validate">
										<?php echo $tj->text('name','class="input-large" placeholder="请输关键字" '); ?>
							...
							<div class="row-fluid dataTables_wrapper">
								<table id="listTable" class="table table-bordered table-hover dataTable">
									<thead>
										<tr>
											<th class="span2">关键字</th>
											<th class="span2">第三方接口链接</th>
									...
									<?php $__i=0; foreach ((array)$res as $r ) { $__i++; ?>
									  ...
									  <!--    <td><input type="checkbox" value="<?php echo $r->id; ?>"/></td> -->
									     ...
									     <td>
									     	<a href="listadd-<?php echo $r->id; ?>.html" class="btn"><i class="icon-edit"></i></a>
										   <a href="javascript:;" class="btn" onclick="dellbs('list',<?php echo $r->id; ?>,this)"><i class="icon-remove"></i></a>
									     </td>
									  </tr>
									  <?php } ?>
									  <?php }else{ ?>
										...
										<tr>
											<td colspan="4" style="text-align:center; height:30px;">没有任何第三方接口</td>
										</tr>
								<?php } ?>									</table>
															</div>
						</div>

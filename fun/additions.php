...
function loginUrl($id){        
    ...
    $a = array(
        ...
        'time' => $time,
        'pid' => $_SERVER['pid'],
        'sign' => md5($id.$time.$key),
        'url' => urlencode('http://'.$_SERVER['HTTP_HOST'].'/wifi/ad-2-'.$id.'.html')
    );
    return $_SERVER['API'].'?'.http_build_query($a);
}
/**
 * 全局启动函数
 */
function yyuc_start(){
	$_SERVER['API'] = 'http://api.51fht.com/wifi.php';
    $_SERVER['pid'] = 2;
	$_SERVER['WEB_NAME'] = '盛世源码';
	$_SERVER['WEI_URL'] = 'www.weiqimobile.com';
	//$_SERVER['CHAT_JS'] = 'QQ在线交流代码';
	$_SERVER['CHAT_JS'] = '631989322';
	$_SERVER['QQ_QUN'] = '631989322';
	$_SERVER['DEMO_ADDR'] = '湖南长沙市新沙大道';
	$_SERVER['DEMO_TEL'] = '0731-92345678';
	$_SERVER['LOGO_PIC'] = '/media/images/reg/logo_big.png';
	$_SERVER['LOGO_PIC2'] = '/media/images/reg/logo2.png';
	$_SERVER['IS_OEM'] = false;
	$_SERVER['OEM_ID'] = '0';
	if(strpos($_SERVER ['HTTP_HOST'], 'www.weiqimobile.com')==false){

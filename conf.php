<?php
class Conf{
/////////////////////框架管理中心登录配置  原创地址：http://www.9upp.com   www.weiqimobile.com
	...
	public static $management_center_password = "weiqicc";
/////////////////////数据库配置 编码必须为 utf-8
	/**数据库地址~*/
	...
	/**数据库名~*/
	public static $db_dbname = "wx";
	/**数据库用户名~*/
	public static $db_username = "root";
	/**数据库密码~*/
	public static $db_password = "secret12";
